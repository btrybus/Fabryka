...
namespace Fabryka1.Controllers
{
    public class OperatorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nazwisko,Imie,Placa")] Operator @operator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nazwisko,Imie,Placa")] Operator @operator)
        {
            if (ModelState.IsValid)
            {
